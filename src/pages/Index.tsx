    ...
    <div className="min-h-screen w-full overflow-hidden">
      ...
      <div className="main-content scrollbar-hide">
        ...
        <section 
          ref={targetRef} 
          id="home" 
          className="section px-6 relative"
        >
          <motion.div
          ...
          >
            ...
            <motion.h2
              ...
              className="text-2xl md:text-3xl font-medium mb-8 text-[#F1F6F9]"
            >
            ...
            <motion.p
              ...
              className="text-lg text-[#9BA4B5] max-w-xl mb-10"
            >
          ...
          >
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 5V19M12 19L19 12M12 19L5 12" stroke="#F1F6F9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </motion.div>
          </motion.div>
        </section>
        ...
        <section id="about" className="section px-6">
          <div className="container mx-auto max-w-5xl">
            ...
            >
              ...
              <div className="space-y-4 text-[#F1F6F9]/90">
                <p>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="space-y-2 text-[#9BA4B5]">
                    <li>React / Next.js</li>
                    <li>TypeScript</li>
        ...
        {/* Projects Section */}
        <section id="projects" className="section px-6 bg-dark-secondary/30">
          <div className="container mx-auto max-w-5xl">
            <SectionHeader 
            ...
            <div className="text-center mt-12">
              <motion.a
                href="#"
                className="inline-flex items-center gap-2 text-accent-cyan hover:text-[#F1F6F9] transition-colors"
                whileHover={{ x: 5 }}
              >
        ...
        {/* Contact Section */}
        <section id="contact" className="section px-6 bg-dark-secondary/30">
          <div className="container mx-auto max-w-5xl">
            <SectionHeader 
              title="Get In Touch" 
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 mt-16">
              ...
              >
                ...
                <a href="mailto:hello@godsonigoniwari.com" className="text-[#9BA4B5] hover:text-accent-cyan transition-colors">
              ...
              >
                ...
                <div className="flex items-center justify-center gap-4">
                  <a href="#" className="text-[#9BA4B5] hover:text-accent-cyan transition-colors">
